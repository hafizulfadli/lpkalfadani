                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea id="ckeditor" class="form-control ckeditor @error('konten') is-invalid @enderror" name="konten" id="" cols="30" rows="5" placeholder="Konten Kerjasama">{{ $about->konten }}</textarea>
                          <div class="invalid-feedback">
                            @error('konten')
                                {{ $message }}
                            @enderror
