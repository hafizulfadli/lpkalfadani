    ...
    <div class="bg-[url({{'/images/unand2.png'}})] sm:bg-white object-cover bg-cover bg-center">
        <div class="py-8 sm:py-12 flex flex-col gap-8 md:gap-16">
            <div class="container flex flex-col gap-8 md:gap-16">
                <h1 class="font-semibold text-2xl sm:text-4xl xl:text-5xl text-hijau-unand flex items-center justify-center gap-2 my-36">Layanan</h1>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-col md:flex-row justify-between gap-8">
            <div class="flex flex-col gap-8 w-full md:w-3/5">
                <div>
                   ...
                   <h2 class="uppercase py-4 text-yellow text-3xl font-semibold">Layanan Terkini</h2>
                </div>
                <div>
                        ...
                        <div class="relative h-[900px] my-4 overflow-hidden">
                            <div class="hidden duration-300 ease-in-out" data-carousel-item>
                                <div class="grid grid-cols-2 grid-rows-2 gap-8">
                                    ...
                                    <div>
                                        <img src="{{ url('thumbnail/'.$data->thumbnail) }}" width="441.2px" height="253.467px" alt="" class="pb-2">
            ...
            <div class="flex flex-col gap-8 w-full md:w-2/5">
                <div>
                   ...
                   <h2 class="uppercase py-4 text-yellow text-3xl font-semibold">Layanan Populer</h2>
                </div>
                <div class="flex flex-col gap-4">
                    @foreach ($layananpopuler as $data )
